...
let mrTotalVotes = 0;
let lrTotalVotes = 0;
for (let i of mrResults) {
    mrTotalVotes += i;
}
for (let i of lrResults) {
    lrTotalVotes += i;
}

// create candidates
const maddieReiff = createCandidate("Maddie Reiff", mrResults, mrTotalVotes);
const lilyRose = createCandidate("Lily Rose", lrResults, lrTotalVotes);
